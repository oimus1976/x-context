...
| AC-CLOSEOUT-03 | `test_unmerged_wrong_base_and_cross_repository_fail_before_sync`, `test_malformed_or_placeholder_like_merge_sha_fails_before_sync` |
...
| AC-CLOSEOUT-08 | `test_native_exit_code_is_authoritative_even_with_stderr_style_output` |
...
| AC-CLOSEOUT-11 | `test_open_closing_issue_blocks_before_sync` |
| AC-CLOSEOUT-12 | `test_merge_push_ci_missing_pending_failed_or_wrong_sha_blocks`, `test_merged_happy_path_derives_shas_and_fast_forwards_main` |
...
| AC-CLOSEOUT-14 | `test_merged_happy_path_derives_shas_and_fast_forwards_main` |
