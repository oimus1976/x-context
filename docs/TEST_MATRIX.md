...
| Post-merge closeout closing-Issue compatibility | Issue #40 AC-CLOSEOUT-F1-01..09; normative `0005-closing-issue-state-clarification.md` | `test_github_pr_reader_uses_real_closing_issue_reference_shape_and_separate_state_lookup`, `test_github_pr_reader_checks_cross_repository_closing_issue_in_reported_repository`, `test_github_pr_reader_rejects_malformed_closing_issue_repository_identity`, `test_github_pr_reader_rejects_issue_number_mismatch_or_missing_state`, `test_github_pr_reader_issue_lookup_unavailable_fails_closed`, `test_github_pr_reader_open_closing_issue_is_preserved_for_policy_validation`, existing `test_success_revalidates_closing_issues_after_local_sync`; full `python -m unittest discover -s tests -v` | First real PR #39 dogfood exposed the missing nested-state assumption and failed closed before canonical sync. Corrected exact-head Windows validation plus repeat PR #39 dogfood are required before Ready. |
...
## Post-merge closeout closing-Issue compatibility mapping

| Acceptance criterion | Automated evidence |
|---|---|
| AC-CLOSEOUT-F1-01 | `test_github_pr_reader_uses_real_closing_issue_reference_shape_and_separate_state_lookup` |
| AC-CLOSEOUT-F1-02 | `test_github_pr_reader_rejects_malformed_closing_issue_repository_identity` |
| AC-CLOSEOUT-F1-03 | `test_github_pr_reader_uses_real_closing_issue_reference_shape_and_separate_state_lookup` |
| AC-CLOSEOUT-F1-04 | `test_github_pr_reader_rejects_issue_number_mismatch_or_missing_state`, `test_github_pr_reader_issue_lookup_unavailable_fails_closed` |
| AC-CLOSEOUT-F1-05 | `test_github_pr_reader_open_closing_issue_is_preserved_for_policy_validation` |
| AC-CLOSEOUT-F1-06 | `test_github_pr_reader_checks_cross_repository_closing_issue_in_reported_repository` |
| AC-CLOSEOUT-F1-07 | existing `test_success_revalidates_closing_issues_after_local_sync` plus default-reader integration/dogfood evidence |
